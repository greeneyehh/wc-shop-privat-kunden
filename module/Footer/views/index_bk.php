  ...
  <div class="container">
    <div class="row mb-4">
      <div class="col-12 col-sm-6 col-lg-3 text-center text-sm-left">
        <a href="/"> <img class="logo" src="/img/windcloud-logo-web-white.svg" alt="windcloud-logo-web-white"/></a>
			<ul id="menu-footer-left" class="menu"><li id="menu-item-35" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-35"><a href="/rechenzentrum">Rechenzentrum</a></li>
				...
				<li id="menu-item-36" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-36"><a href="/unternehmen">Unternehmen</a></li>
			</ul>
    ...
    <div  class="d-flex flex-wrap mt-5 justify-content-sm-end float-right footer-copyright align-items-center">
      <div id="copy" class="col-auto float-right footer-copyright-text">
        <p>Copyright &copy; 2019 Windcloud 4.0 GmbH</p>
      </div>
