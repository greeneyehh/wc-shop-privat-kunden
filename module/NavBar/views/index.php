             ...
             <ul class="navbar-nav">
                      ...
                      <?php
						...
						foreach($mainMenu as $menuItem) {
                          ...
                          <li id="menu-item-<?= $menuItem->id ?>" class="nav-item">
                        ...
                        <li class="nav-item dropdown position-static">
                         <a data-hover="dropdown" <?php if ($menuItem->click == 1) { echo 'data-click="'.$menuItem->url.'"';}  ?> href="<?php if ($menuItem->url == "") { echo "javascript:void(0);";} else { echo $menuItem->url;} ?>" class="nav-link" ><?=$menuItem->linkname ?></a>
                            <span data-toggle="dropdown" class="subnavlink d-lg-none"></span>
                           ...
                           <?php
                            ...
                            ?>
                             ...
                             <li class="col-auto text-center nav-item">
                                 <a class="nav-link total-count" href="/cart"><i class="fa fa-shopping-basket"></i>
...
/*
 ...
 $this->registerJs("$('.subnavlink').on('click', function(e) {
