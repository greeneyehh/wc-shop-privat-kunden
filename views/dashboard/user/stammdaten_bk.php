...
<div class="row">
    <div class="col-md-8">
        <div class="card card-primary">
            ...
            <div class="card-body">
                <pre>
                <?php print_r($stamdaten['addresses']);?>
                </pre>


                <?php if($stamdaten['primaryAddressId'] == $stamdaten['invoiceAddressId']){
                    echo 'es gibt nur eine adresse';
                }else{
                    echo 'es gibt zwei adresse';
                }
            ...
            <div class="card-footer">
                    <?= Html::submitButton('Daten ändern', ['class' => 'btn btn-primary']) ?>
