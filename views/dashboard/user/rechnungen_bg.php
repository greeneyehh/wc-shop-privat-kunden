    ...
    <div class="col-md-6">
        <div class="card card-primary ">
            ...
            <div class="card-body" style="min-height: 250px">
                ...
                <p></p>
             <div class="row">
                 <div class="col-md-6">  <button type="button" class="btn btn-default" onclick="leerenSuchfeld(); return false;">Suche zurücksetzen</button> </div>
                 <div class="col-md-6">  <button type="submit" class="btn btn-default" id="filter">Suchen</button></div>
