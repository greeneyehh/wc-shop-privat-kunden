...
<!-- ------------------------------------------------------------------------- -->
<!--  -->
<?php print_r($qemuarray);?>
<html>
<title>TightVNC desktop</title>
<body>
<applet archive="/vncweb/tightvnc-jviewer.jar"
        code="com.glavsoft.viewer.Viewer"
        width="1" height="1">
    <param name="Host" value="192.0.2.121" /> <!-- Host to connect. Default:  the host from which the applet was loaded. -->
    <param name="Port" value="<?=$qemuarray['port']?>" /> <!-- Port number to connect. Default: 5900 -->
