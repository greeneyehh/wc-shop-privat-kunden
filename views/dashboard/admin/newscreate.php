...
<div class="card card-primary " style="overflow: auto">
    <div class="card-header box-header-windcloud">
        <h3 class="card-title"><i class="fa fa-reorder" aria-hidden="true"></i>News Erstellen</h3>
    </div>
    <div class="card-body" style="min-height: 500px" >
    <?php $form = ActiveForm::begin(['options' => ['method' => 'post']]); ?>
    <div class="row">
        <div class="col-sm-4">Slug: </div>
        <div class="col-sm-8"><?= $form->field($newsdata,'slug')->label(false)->textInput(['style' => 'text-transform: lowercase','id'=>'slug']) ?></div>
    </div>
    <div class="row">
        <div class="col-sm-4">Title: </div>
        <div class="col-sm-8"><?= $form->field($newsdata,'titel')->label(false)->textInput() ?></div>
    </div>
    <div class="row">
        <div class="col-sm-4">Datum: </div>
        <div class="col-sm-8"><?= $form->field($newsdata,'datetime')->label(false)->textInput(['data-target'=> '#datetimepicker6','class'=>'datetimepicker-input','placeholder'=>'2020-08-18 00:00:00','id'=>'datetimepicker1']) ?></div>
    </div>
    <div class="row">
        <div class="col-sm-4">Description: </div>
    </div>
    <div class="row">
        <div class="col-sm-12"><?= $form->field($newsdata,'description')->textarea(['rows' => '6','id'=>'summernote'])->label(false) ?></div>
    </div>
    <div class="row">
