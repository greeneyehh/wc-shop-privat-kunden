...
?>
    ...
    <h3 class="box-title">Nextcloud Transferlog</h3>
            ...
            <table id="log" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                ...
                <?php foreach ($log as $position => $logs): ?>
                    ...
                    <tr>
                        ...
                        <td><?= $logs['type'] ?></td>
                        <td style="height:80px;max-width: 300px; overflow:scroll"><?= $logs['content'] ?></td>
                        <td style="height:80px;max-width: 300px; overflow:scroll"><?=htmlspecialchars ( $logs['postfiels'], ENT_NOQUOTES); ?></td>
                        <td style="height:80px;max-width: 300px; overflow:scroll"><?= $logs['result'] ?></td>
