...
<input autocomplete="section-personal given-name" name="register[personal][firstname]" type="text" required="required" aria-required="true" placeholder="Vorname*" id="firstname" value="" class="register--field is--required has--error">
</div>
<div class="register--lastname">
<input autocomplete="section-personal family-name" name="register[personal][lastname]" type="text" required="required" aria-required="true" placeholder="Nachname*" id="lastname" value="" class="register--field is--required has--error">
</div>
...
<input name="register[personal][passwordConfirmation]" type="password" autocomplete="new-password" aria-required="true" placeholder="Wiederhole Dein Passwort*" id="register_personal_passwordConfirmation" class="register--field passwordConfirmation is--required" required="required">
</div>
<div class="register--password-description">
Dein Passwort muss mindestens  6 Zeichen umfassen.<br>Bitte berücksichtige Groß- und Kleinschreibung.
</div>
</div>
...
<div class="register--password-description">
Wir verwenden Deine Telefonnummer nur, wenn wir Dich im Zusammenhang mit Deiner Bestellung erreichen müssen und geben sie auf keinen Fall an Dritte weiter. Versprochen!
</div>
