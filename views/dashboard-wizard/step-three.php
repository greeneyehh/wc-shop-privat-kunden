        ...
        <?php
                                ...
                                <div class="product-price-brutto justify-content-md-center" style="font-size: 1rem">
                                    ...
                                    <?= Html::submitButton('auswählen',
                                        ['style'=>'vertical-align: bottom; width: 100%;',
                                            ...
                                            'data-id'=>$products['id'],'data-name'=>$products['name'],'data-price' =>$products['articlePrices']['0']['price'],'data-customerid'=>$customerid]);
                                    ?>
                                </div>
                            </div>
                        </div>
                ...
                ?>
                    <?= Html::submitButton('Ohne Auswahl weiter',
                        ['style'=>'vertical-align: bottom; width: 100%;',
                            'class' => 'border mobile-fill anim-1 show align-self-end without-choice','data-noPanel'=>1,'data-customerid'=>$customerid]);
                    ?>
        </div>
</div>
...
var produktdata ={};
    ...
    $.ajax({
      type: 'POST',
      url: '/dashboard-wizard/step-four',
      data:  produktdata,
