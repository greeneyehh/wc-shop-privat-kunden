...
<div class="card" id="stepfive">
    <div class="card-header border-radius-d cart-card-addon" style="text-align: center;">
        <h3 class="vary">IHRE VPS KONFIGURATION</h3>
    </div>
    <div class="card-body row">
        ...
        <?= Html::submitButton('In den Warenkorb',
            ['style'=>'vertical-align: bottom; width: 100%;',
                'class' => 'border mobile-fill anim-1 show align-self-end step-four','data-customerid'=>$customerid,
                'data-id'=>"vps"]);
        ?>
