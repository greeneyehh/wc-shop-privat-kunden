        ...
        <div id="hero" class="row margin-b">
            ...
            <div class="col mb-4">
                <div class="pic">
                    ...
                    <img class="net" srcset="<?= Url::to('@web/image/Windcloud-net.webp');?> 2000w, <?= Url::to('@web/image/Windcloud-net-300x212.webp');?> 300w, <?= Url::to('@web/image/Windcloud-net-768x543.webp');?> 768w, <?= Url::to('@web/image/Windcloud-net-1024x724.webp');?> 1024w amp-img, <?= Url::to('@web/image/Windcloud-net-1200x848.webp');?>  1200w" sizes="(min-width: 1200px) 540px, (min-width: 992px) 450px, (min-width: 768px) 330px, (min-width: 576px) 510px, calc(100vw - 30px)" src="<?= Url::to('@web/image/Windcloud-net-1024x724.webp');?>" title="Windcloud-net" alt="Netz">
        ...
        <div class="videowall col-12 margin-b">
            <div class="row">
                ...
                <div class="col-5 col-md-4 order-2 order-md-1" style="z-index: 8;">
                    <video id="video_background" preload="auto" autoplay="true" loop="loop" muted="muted" volume="0">
                        <source src="<?= Url::to('@web/image/Windcloud-Turmplatte01.webm');?>" type="video/webm">
                    </video>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-5 col-md-4 order-2 order-md-1" style="z-index: 6;">
                    <span class="tiletext right d-none d-lg-block">Der Strom für die Windcloud-Rechenzentren kommt zu 100% aus lokaler Erneuerbarer Energie.</span>
                    <video id="video_background" preload="auto" autoplay="true" loop="loop" muted="muted" volume="0">
                        <source src="<?= Url::to('@web/image/Windcloud-Turmplatte02.webm');?>" type="video/webm">
                    </video>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-5 col-md-4 order-2 order-md-1" style="z-index: 4;">
                    <span class="tiletext left d-none d-lg-block">Die Server-Abwärme ist bei uns kein Abfall-Produkt. Wir nutzen diese zusammen mit Partnern bspw. für das Beheizen einer Algenfarm. Damit steigern wir die Nachhaltigkeit und Wirtschaftlichkeit unseres Gesamtsystems.</span>
                    <video id="video_background" preload="auto" autoplay="true" loop="loop" muted="muted" volume="0">
                        <source src="<?= Url::to('@web/image/Windcloud-Turmplatte03.webm');?>" type="video/webm">
                    </video>
                </div>
                <div class="col-7 col-md-4 order-0 order-md-2">
                    <div class="bubble right">
            ...
            <div class="row">
                ...
                <div class="col-5 col-md-4 order-2 order-md-1" style="z-index: 2;">
                    <span class="tiletext right d-none d-lg-block">Algen finden sowohl in der Nahrungsmittelindustrie als auch in der Kosmetik- und Pharmabranche Verwendung. Somit generieren wir aus dem Rechenzentrumsbetrieb ein zusätzliches nachhaltiges Produkt.</span>
                    <video id="video_background" preload="auto" autoplay="true" loop="loop" muted="muted" volume="0">
...
<?php
$this->registerCssFile("/css/cms/style-oekosystem.minify.css");
?>
