...
?>
    <div class="container">
        ...
        <div class="container-fluid text-center">
            <div id="carousel-items" class="carousel slide" data-ride="carousel" data-interval="false">
                ...
                <?php foreach ($model['result'] as $key => $products): ?>
                    <div class="carousel-item col-12 col-sm-6 col-md-4 col-lg-3 <?=($key == '0' ? 'active' : '');?>">
                        <div class="bg-darkblue border-radius-d adjust-h">
                            ...
                            <br></br>
                                    ab <?=$products['articlePrices']['0']['price'];?> € / Monat
                                <br>
                                <?php
...
$this->registerCssFile("@web/css/cms/style-vps-2.css");
?>