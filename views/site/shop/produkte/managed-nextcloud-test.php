    ...
    <div class="container">
        ...
        <div class="column-count margin-b" id="managed-nextcloud">
            <p>
                ...
                Sie behalten die volle Kontrolle. Die Bedienung Ihrer Nextcloud ist ganz einfach - Sie brauchen keine Expertenkenntnisse. Alle Updates übernehmen wir für Sie.
        ...
        <div class="d-md-block margin-b">
            <div class="row">
                <?php foreach ($model['result'] as $products): ?>
                  <pre>
                    <?php print_r($products['customAttributes']);?>
                  </pre>
                        ...
                        <div class="bg-darkblue border-radius-d box-shadow adjust-h">
                            <div class="p-3">
                                ...
                                if(empty($variant["result"])){
                                    ...
                                    echo Html::submitButton('In den Warenkorb', ['class' => 'border mobile-fill anim-1 btn-ajax-modal show', 'data-toggle'=> 'modal','data-target'=> '#variant-modal','value' => Url::to('/ajax/variant?id='.$products['id']),]);
                                }
                                ?>
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-7">
                        <p class="mb-2"><strong>CO2-frei:</strong>  Unsere Cloud-Lösungen sind durch den Bezug von 100 % physikalisch grünen Strom CO2-frei.</p>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title vary" id="exampleModalLongTitle">Zahlungsintervall und laufzeit</h5>
