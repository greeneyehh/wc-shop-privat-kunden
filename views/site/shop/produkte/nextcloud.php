...
?>
    ...
    <div id="hero" class="row">
        <div class="col-8 col-lg-5">
            ...
            <a class="border mobile-fill anim-1 show" href="javascript:">Direkt starten!</a>
        </div>
        <div class="col mb-4">
            <div class="pic">
    ...
    <div class="column-count margin-b">
        <p>
            Speichern, verwalten und bearbeiten Sie Ihre Daten flexibel und ubersichtlich in der Cloud und bestimmen Sie selbst, wer welche Zugriffsrechte hat. Sie behalten die volle Kontrolle. Die Bedienung Ihrer Nextcloud ist ganz einfach - Sie brauchen keine Expertenkenntnisse. Alle Updates ubernehmen wir fur Sie. Ihre Nextcloud betreiben wir ausschließlich in unseren ISO 27001-zertifizierten und CO2-neutralen Rechenzentren in Schleswig-Holstein. Zur Einhaltung Ihrer Compliance-Richtlinien bieten wir Ihnen zudem ein gepruftes DSGVO-konformes Vertragswerk. Wir garantieren Ihnen Datenschutz nach deutschem und europäischem Recht
        </p>
    </div>
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-3 mb-4">
                <div class="bg-darkblue border-radius-d box-shadow adjust-h">
                    <div class="p-3">
                        <h3 class="vary" style="min-height: 29px;">START</h3>
                        <p>25 GB Speicher<br>1GB Traffic<br>Einezelner Nutzer<br>Shared Nextcloud<br><strong>25€ / Jahr</strong></p>
                        <a class="border mobile-fill anim-1 show" href="javascript:">in den Warenkorb</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-4">
                <div class="bg-darkblue border-radius-d box-shadow adjust-h">
                    <div class="p-3">
                        <h3 class="vary" style="min-height: 29px;">BRISE</h3>
                        <p>200 GB Speicher<br>1 GB Traffic<br>Unbegrenzte Nutzer<br>Eigener virtueller<br>Server / Domain<br><strong>25€ / Jahr</strong></p>
                        <a class="border mobile-fill anim-1 show" href="javascript:">in den Warenkorb</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-4">
                <div class="bg-darkblue border-radius-d box-shadow adjust-h">
                    <div class="p-3">
                        <h3 class="vary" style="min-height: 29px;">STURM</h3>
                        <p>200 GB Speicher<br>1 GB Traffic<br>Unbegrenzte Nutzer<br>Eigener virtueller<br>Server / Domain<br><strong>25€ / Jahr</strong></p>
                        <a class="border mobile-fill anim-1 show" href="javascript:">in den Warenkorb</a>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-4">
                <div class="bg-darkblue border-radius-d box-shadow adjust-h">
                    <div class="p-3">
                        <h3 class="vary" style="min-height: 29px;">ORKAN</h3>
                        <p>200 GB Speicher<br>1 GB Traffic<br>Unbegrenzte Nutzer<br>Eigener virtueller<br>Server / Domain<br><strong>25€ / Jahr</strong></p>
                        <a class="border mobile-fill anim-1 show" href="javascript:">in den Warenkorb</a>
                    </div>
                </div>
    ...
    <div class="bg-c-white border-radius-d margin-b pad">
        ...
        <div class="column-count">
            <ul>
                ...
                <li>Privater virtueller Server für Ihre Nextcloud</li>
                ...
                <div class="carousel-item row justify-content-center align-items-center" style="min-height: 230px;">
                    <div class="bg-c-darkblue border-radius-d pad">
                        <div class="col-12">
                            <div class="row align-items-center">
                                <div class="col-12 col-lg-6 mb-4">
                                    <img src="image/cloud-screen-05.jpg" alt="Cloud Screen">
                                </div>
                                <div class="col-12 col-lg-6">
        ...
        <div class="col-12">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <img src="image/Windcloud-windraeder-768x543.png" alt="Windcraft">
                </div>
                <div class="col-12 col-lg-7">
                    <p class="mb-2"><strong>CO2-neutral:</strong> Unsere Cloud-Lösungen sind nicht nur rechnerisch, sondern echt zu 100 % CO2-frei. Das erreichen wir durch unsere Infrastruktur.</p>
                    <p class="mb-2"><strong>Erneuerbare Energie:</strong> An unserem Standort in Nordfriesland (Schleswig-Holstein) nutzen wir direkt Strom aus lokaler Windenergie.</p>
                    <p class="mb-2"><strong>Abwärme-Veredelung:</strong> Im Zuge des Ausbaus unserer Rechenzentren werden wir die Abwärme unserer Server.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="accordion" id="faqExample">
                <div>
                    ...
                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#faqExample">
                        <div class="card-body">
                            Die Bereitstellung Ihrer Nextcloud dauert werktags maximal 24 Stunden. In der Regel steht Ihnen die Nextcloud aber schneller zur Verfügung.
                            Sobald Ihre Nextcloud fertig eingerichtet ist, erhalten Sie eine E-Mail mit Zugangsdaten und können dann direkt starten.
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#faqExample">
                        <div class="card-body">
                            Ihre Daten schützen wir in der Nextcloud mit verschiedenen Maßnahmen vor unbefugtem Zugriff und Verlust.
                            So speichern wir Ihre Daten ausschließlich auf CEPH-Datenspeichern, auf denen Ihre Daten zu jeder Zeit 3-fach redundant gesichert sind.
                            Die Datenübertragung erfolgt verschlüsselt über SSL. Zudem setzen wir nur modernste Hardware in unserem eigenen hochverfügbaren Rechenzentrum für den Betrieb Ihrer Nextcloud ein.
                            Optional können Sie noch eine Zwei-Faktor-Authentifizierung (2FA) in Ihrer Nextcloud aktivieren.
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#faqExample">
                        <div class="card-body">
                            Wir speichern Ihre Daten ausschließlich in unserem CO2-freien Rechenzentrum in Nordfriesland / Schleswig-Holstein.
                            Das Rechenzentrum ist EN 50600 VK 3 zertifiziert und besitzt damit die zweithöchste Verfügbarkeitsklasse (hochverfügbar). Das Rechenzentrum hat eine redundante Stromversorgung und eine automatische Brandmelde- und Löschanlage. Zudem ist es geographisch mehrfach redundant ans Glasfasernetz angebunden.
                        </div>
                    </div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div id="collapseFive" class="collapse" aria-labelledby="headingThree" data-parent="#faqExample">
                        <div class="card-body">
                            Nein, die Nextcloud ist ein einfach zu bedienender Cloud-Speicher, der besonders benutzerfreundlich ist. Den Betrieb der Hardware und der Server-Infrastruktur im Hintergrund übernehmen wir für Sie. Somit können Sie sich aufs wesentliche konzentrieren. Auch Updates der Nextcloud nehmen wir auf Wunsch kostenlos für Sie vor. Sollten Sie trotzdem einmal ein Frage oder ein Problem haben, können Sie sich jederzeit an unseren Support (support@windcloud.de) wenden.
                        </div>
                    </div>
                </div>
            </div>
