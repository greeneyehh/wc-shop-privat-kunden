...
<div id="hero">
    ...
    <div style="display: none;" class="d-md-block" style="padding-top: 4rem;">
        <h2  style="display: none;" class="vary text-center">DAS TEAM</h2>
    </div>
    <div class="d-md-block" style="display: none;">
        <div class="row">
            <div class="col-12 col-md-6 col-lg-3 mb-4 team-col">
                <div class="team">
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-4 team-col">
                <div class="team">
                    <img class="team-img" src="<?= Url::to('@web/image/team/WOLFGANG-GÖTTGENS.webp');?>">
                </div>
                <h1>Key Account Manager</h1>
                <h2 class="vary font-size-3">WOLFGANG<br>GÖTTGENS</h2>
                <p>Sales & Partnerschaften</p>
            </div>
            <div class="col-12 col-md-6 col-lg-3 mb-4 team-col">
                <div class="team">
                    <img class="team-img" src="<?= Url::to('@web/image/team/CHRISTIAN-KALUZA.webp');?>">
                </div>
                <h1>Marketing Manager</h1>
                <h2 class="vary font-size-3">CHRISTIAN<br>KALUZA</h2>
                <p>Marketing & PR</p>
            </div>
