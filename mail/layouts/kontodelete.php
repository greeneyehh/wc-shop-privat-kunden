...
Black&quot;,sans-serif;color:#3B3838;mso-style-textfill-fill-color:#3B3838;mso-style-textfill-fill-alpha:100.0%"></span></strong><strong><span
                                        style="font-size:16.0pt;font-family:&quot;Arial
Black&quot;,sans-serif;color:#3B3838;mso-style-textfill-fill-color:#3B3838;mso-style-textfill-fill-alpha:100.0%">Unwiderrufliche Löschung des Kundenkontos</span></strong><span
                                    style="color:#3B3838;mso-style-textfill-fill-color:#3B3838;mso-style-textfill-fill-alpha:100.0%"></span><br>
                            <br>
                            <span
                                    style="color:#404040;mso-style-textfill-fill-color:#404040;mso-style-textfill-fill-alpha:100.0%">Hallo
                      <?php print_r($name) ?>,<br>
                      du möchten dein Kundenkonto bei der Windcloud 4.0 unwiderruflich löschen.<br>
                      Klick auf die Schaltfläche unten, um den Zugang zu deinem Kundenportal und die dort von dir hinterlegten Daten zu löschen.
</span></p>
                        <p class="MsoNormal" style="text-align:center"
                           align="center"><br>
                            <span style="color:#404040;mso-style-textfill-fill-color:#404040;mso-style-textfill-fill-alpha:100.0%"><a href="<?=Url::home('https').'dashboard/kontodelete/?token=' . $mailcode .'&mail='.$mail;?> ">
                              Kundenkonto unwiderruflich löschen</a></span></p>
                        <p class="MsoNormal" style="text-align:center"
                           align="center"><br>
                            <span
                                    style="color:#404040;mso-style-textfill-fill-color:#404040;mso-style-textfill-fill-alpha:100.0%">

Dieser Link ist die nächsten 24 Stunden gültig
<br>
                    </span></p>
                        <p class="MsoNormal" style="text-align:center"
                           align="center"><span
                                    style="color:#404040;mso-style-textfill-fill-color:#404040;mso-style-textfill-fill-alpha:100.0%">Stelle
                      sicher, dass nur du Zugriff auf dein Kundenportal
                      hast. <br>
                    </span></p>
                        <p class="MsoNormal" style="text-align:center" align="center"><span style="color:#404040;mso-style-textfill-fill-color:#404040;mso-style-textfill-fill-alpha:100.0%"><br>
                    </span></p>
                        <p class="MsoNormal" style="text-align:center" align="center"><span style="color:#404040;mso-style-textfill-fill-color:#404040;mso-style-textfill-fill-alpha:100.0%">Haben Sie Fragen? Kontaktieren Sie uns: </span><a href="mailto:moin@windcloud.de" moz-do-not-send="true">moin@windcloud.de</a></p>
