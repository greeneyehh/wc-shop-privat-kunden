                ...
                <tr>
                    <td class="innerpadding bodycopy borderbottom">
                        <p class=MsoNormal align=center style='text-align:center'><o:p>&nbsp;</o:p></p><p class=MsoNormal align=center style='text-align:center'>
                            ...
                            <br><br>
                            Ihr Virtual Private Server steht nun für Sie bereit und ist unter der folgenden IP für Sie erreichbar.
                            <br><br>
                            IP : <?=$ip; ?>
                            <br><br>
                            Bitte schließen Sie die Erstkonfiguration ab. Dies kann bis zu 10 Minuten dauern.
                            <a href="<?=\Yii::$app->params['BASE_URL']?>/dashboard/vps?id=<?=$vpsid;?>">Erstkonfiguration</a>
                    </td>
                </tr>
                <tr>
