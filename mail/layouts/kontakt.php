            ...
            <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td class="innerpadding bodycopy borderbottom">
                        ...
                        <?php if($callback == 1)
                        {
                        echo "<span style='font-size:12.0pt;sans-serif;color:#3B3838;mso-style-textfill-fill-color:#3B3838;mso-style-textfill-fill-alpha:100.0%'>um rückruf gebeten: ". $phonenumber."</span>";
                        echo "</strong>";
                        }
                        ?>
                        ...
                        <br>
                        <strong>
                            <span style='font-size:12.0pt;font-family:"Arial Black",sans-serif;color:#3B3838;mso-style-textfill-fill-color:#3B3838;mso-style-textfill-fill-alpha:100.0%'>Nachricht: <p><?= $message;?></p></span>
                        </strong>
