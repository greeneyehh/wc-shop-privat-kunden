            ...
            <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td class="innerpadding bodycopy borderbottom">
                        <strong><span style='font-size:16.0pt;font-family:"Arial Black",sans-serif;color:#3B3838;mso-style-textfill-fill-color:#3B3838;mso-style-textfill-fill-alpha:100.0%'>Bitte bestätigen Sie Ihre Anmeldung</span></strong>
                        <br>
                        <br>
                        <strong><span style='font-size:12.0pt;font-family:"Arial Black",sans-serif;color:#3B3838;mso-style-textfill-fill-color:#3B3838;mso-style-textfill-fill-alpha:100.0%'><a href="<?=Url::home('https').'mail-chimp/newsletter-confirm/?token=' . $mailcode;?>">Ja, nehmen Sie mich in Ihre Liste auf.</a></span></strong>
                        <br>
                        <br>
                        Wenn Sie sich nicht zum Newsletter der Windcloud 4.0 GmbH angemeldet haben,
                        <br>
                        können Sie diese E-Mail löschen. Die Newsletter-Anmeldung wird nur abgeschlossen,
                        <br>
                        wenn Sie auf den oben stehenden Bestätigungs-Link klicken.
                        <br>
                        <br>
                        Haben Sie Fragen? Kontaktieren Sie uns: <a href="mailto:moin@windcloud.de">moin@windcloud.de</a>
                        <br>
                        <br>
                    ...
                    <td class="innerpadding">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="smallcopy">
                                    Diese Nachricht
                                    wurde von Windcloud 4.0 GmbH an <?= base64_decode($mailcode) ;?> ver­sandt.
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="center" class="footercopy">
                                    ...
                                    <br>
                                    <br>
                                    <a href="<?=Url::home('https').'mail-chimp/newsletter-delete/?token=' . $mailcode;?>" class="unsubscribe"><font>ABMELDEN</font></a>
                                </td>
                            </tr>
                        </table>
                    </td>
