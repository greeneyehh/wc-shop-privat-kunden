            ...
            <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td class="innerpadding bodycopy borderbottom">
                        <strong><span style='font-size:16.0pt;font-family:"Arial Black",sans-serif;color:#3B3838;mso-style-textfill-fill-color:#3B3838;mso-style-textfill-fill-alpha:100.0%'>Antrag auf Passwortänderung</span></strong><p>
                        <span style="color:#404040;mso-style-textfill-fill-color:#404040;mso-style-textfill-fill-alpha:100.0%">Hallo
                      <?php print_r($name) ?>,<br>
                      ...
                      Sie Fragen? Kontaktieren Sie uns: </span><a
                                    href="mailto:moin@windcloud.de" moz-do-not-send="true">moin@windcloud.de</a></p>
                    </td>
                </tr>
                <tr>
