...
/**
 * This is the model class for table "account_inport".
 *
 ...
 * @property string|null $deleteToken
 * @property string|null $forgotpasswordtime
 * @property string|null $deletetime
 * @property string $remote_addr
 * @property int $right
 */
class AccountInport extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
           ...
           // [['personal_customer_type', 'personal_salutation', 'personal_firstname', 'personal_lastname', 'personal_email', 'personal_password', 'personal_passwordConfirmation', 'personal_phone', 'personal_birthday_day', 'personal_birthday_month', 'personal_birthday_year', 'billing_company', 'billing_department', 'billing_vatId', 'billing_street', 'billing_additionalAddressLine1', 'billing_zipcode', 'billing_city', 'billing_country', 'billing_shippingAddress', 'shipping_salutation', 'shipping_company', 'shipping_department', 'shipping_firstname', 'shipping_lastname', 'shipping_street', 'shipping_additionalAddressLine1', 'shipping_zipcode', 'shipping_city', 'shipping_country', 'remote_addr'], 'required'],
            [['personal_customer_type', 'personal_salutation',  'remote_addr'], 'required'],
            [['right'], 'integer'],
            [['personal_customer_type', 'personal_salutation', 'personal_firstname', 'personal_lastname', 'personal_email', 'personal_password', 'personal_passwordConfirmation', 'personal_phone', 'billing_company', 'billing_department', 'billing_vatId', 'billing_street', 'billing_additionalAddressLine1', 'billing_zipcode', 'billing_city', 'billing_country', 'billing_shippingAddress', 'shipping_salutation', 'shipping_company', 'shipping_department', 'shipping_firstname', 'shipping_lastname', 'shipping_street', 'shipping_additionalAddressLine1', 'shipping_zipcode', 'shipping_city', 'shipping_country', 'authKey', 'deleteToken', 'forgotpasswordtime', 'deletetime', 'remote_addr'], 'string', 'max' => 255],
